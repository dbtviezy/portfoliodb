...
CREATE TABLE "Portfolio" (
    ...
    "contactEmail" TEXT NOT NULL DEFAULT 'daniilbautin0@gmail.com',
    "contactTelegram" TEXT NOT NULL DEFAULT '@dbtviezy',
    "contactBehance" TEXT NOT NULL DEFAULT 'behance.net/3606019f',
    "contactDribbble" TEXT NOT NULL DEFAULT 'dribbble.com/db-tviezy',
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL
);
