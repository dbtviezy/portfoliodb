    ...
    >
      ...
      >
        <Link
          ...
          className="flex min-w-0 items-center truncate font-mono text-[10px] font-bold tracking-wider text-[var(--text-muted)] transition hover:text-[var(--text)] sm:text-xs"
          aria-label="Home"
        >
          $ {displayText}
        </Link>
